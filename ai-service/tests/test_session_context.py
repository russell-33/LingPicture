...
class SessionContextTest(unittest.TestCase):
    ...
    def test_build_agent_messages_contains_summary_and_task(self, *_):
    ...
    def test_build_agent_messages_falls_back_to_mysql_summary(self, _messages, _redis_summary, _mysql_summary, save_summary):
